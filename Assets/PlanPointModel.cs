...
[RealtimeModel]
public partial class PlanPointModel
{
...
public partial class PlanPointModel : RealtimeModel {
    ...
    public PlanPointModel() : this(null) {
    }
    
    public PlanPointModel(RealtimeModel parent) : base(null, parent) {
    }
