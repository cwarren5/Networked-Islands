...
[RealtimeModel]
public partial class PlanStrokeModel
{
    [RealtimeProperty(1, true)]
    private RealtimeArray<PlanPointModel> _ribbonPoints;
...
public partial class PlanStrokeModel : RealtimeModel {
    ...
    public Normal.Realtime.Serialization.RealtimeArray<PlanPointModel> ribbonPoints {
    ...
    public PlanStrokeModel() : this(null) {
    }
    
    public PlanStrokeModel(RealtimeModel parent) : base(null, parent) {
        RealtimeModel[] childModels = new RealtimeModel[1];
        
        _ribbonPoints = new Normal.Realtime.Serialization.RealtimeArray<PlanPointModel>();
